...
CREATE TABLE IF NOT EXISTS bicha_menu_items (
  ...
  category TEXT NOT NULL, -- 'birras', 'tragos', 'comida', 'otros'
  description TEXT,
...
CREATE TABLE IF NOT EXISTS bicha_packs (
  ...
  price NUMERIC(10,2) NOT NULL,
  includes_pingpong BOOLEAN DEFAULT false,
...
CREATE TABLE IF NOT EXISTS bicha_pack_purchases (
  ...
  pingpong_available BOOLEAN DEFAULT false,
...
-- Sample packs
INSERT INTO bicha_packs (name, description, category, units, price, includes_pingpong) VALUES
  ('Trío de Birras', '3 pintas a elección', 'birras', 3, 9000, false),
  ('Docena de Birras', '12 pintas a elección + 1h ping pong', 'birras', 12, 33000, true),
  ('Trío de Fernets', '3 fernets con Coca', 'fernets', 3, 10500, false),
  ('Trío de Empanadas', '3 empanadas del mismo sabor', 'empanadas', 3, 4000, false),
  ('Docena de Empanadas', '12 empanadas del mismo sabor + 1h ping pong', 'empanadas', 12, 14000, true);
