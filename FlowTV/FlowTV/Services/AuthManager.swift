...
class AuthManager: ObservableObject {
    ...
    private func completeEasyLogin(token: String, accountId: String?) async {
        ...
        // Configure and start FlowM11Service
    ...
    func loginAsDemo() {
        ...
        // Configure and fetch real channels immediately
        configureM11Service()
        Task { @MainActor in
            authLog.info("[Auth] Demo: fetching real M11 channels...")
            await FlowM11Service.shared.fetchChannels()
            authLog.info("[Auth] Demo: M11 channels loaded: \(FlowM11Service.shared.channels.count)")
        }
    }

    private func configureM11Service() {
        ...
        authLog.info("[Auth] M11 service configured")
    }
